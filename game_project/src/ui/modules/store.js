...
export const DIFFICULTY_PRESETS = [
    ...
    { label: "困难", desc: "敌人更具威胁", params: { playerDamageMultiplier: 1.0, enemyDamageMultiplier: 0.6, enemyHpMultiplier: 1.5, xpGainMultiplier: 1.2 } },
    { label: "痛苦", desc: "容错率极低", params: { playerDamageMultiplier: 0.8, enemyDamageMultiplier: 0.7, enemyHpMultiplier: 2, xpGainMultiplier: 2 } },
    { label: "地狱", desc: "甚至无法呼吸...", params: { playerDamageMultiplier: 0.7, enemyDamageMultiplier: 0.8, enemyHpMultiplier: 2.5, xpGainMultiplier: 2.5 } }
];
